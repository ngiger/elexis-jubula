...
@SrcNode(UUID = "8ab6b0832254bb19012254f1fd800007",
         type = NodeType.TEST_CASE)
public class Ub_fcv_checkExistenceOfFigure_byTextpath {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_fcv_checkExistenceOfFigure_byTextpath.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_fcv;
    
    
    public Ub_fcv_checkExistenceOfFigure_byTextpath (RuntimeContext _rtc,
