...
@SrcNode(UUID = "8ab6b0832433fd970124343a0f750046",
         type = NodeType.TEST_CASE)
public class Ub_grc_checkExistenceOfContextMenuEntryWithPositionSpec_byIndexpath {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_grc_checkExistenceOfContextMenuEntryWithPositionSpec_byIndexpath.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_grc;
    
    
    public Ub_grc_checkExistenceOfContextMenuEntryWithPositionSpec_byIndexpath (RuntimeContext _rtc,
