...
@SrcNode(UUID = "8ab6b0832433fd97012434411ec7005c",
         type = NodeType.TEST_CASE)
public class Ub_grc_checkSelectionOfContextMenuEntry_byTextpath {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_grc_checkSelectionOfContextMenuEntry_byTextpath.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_grc;
    
    
    public Ub_grc_checkSelectionOfContextMenuEntry_byTextpath (RuntimeContext _rtc,
    ...
    public void execute(
        ...
        aut.execute(
            org.eclipse.jubula.toolkit.base.AbstractComponents.createGraphicsComponent(nn_nn_grc)
                .checkSelectionOfContextMenuEntryByTextpath(
                    TEXTPATH
                    ,
