...
@SrcNode(UUID = "8ab6b083150339b501150364afe807c4",
         type = NodeType.TEST_CASE)
public class Ub_app_pressAnyKeyCombination_SHIFT {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_pressAnyKeyCombination_SHIFT.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_pressAnyKeyCombination_SHIFT (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
