...
@SrcNode(UUID = "8ab6b083150339b501150364afe807da",
         type = NodeType.TEST_CASE)
public class Ub_app_pressAnyKeyCombination_CTRL {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_pressAnyKeyCombination_CTRL.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_pressAnyKeyCombination_CTRL (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
