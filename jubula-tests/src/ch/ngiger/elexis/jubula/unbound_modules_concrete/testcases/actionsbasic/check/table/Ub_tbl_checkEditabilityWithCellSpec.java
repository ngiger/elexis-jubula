...
@SrcNode(UUID = "8ab6b08d294519bd012945e6d5d00725",
         type = NodeType.TEST_CASE)
public class Ub_tbl_checkEditabilityWithCellSpec {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_tbl_checkEditabilityWithCellSpec.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_tbl;
    
    
    public Ub_tbl_checkEditabilityWithCellSpec (RuntimeContext _rtc,
