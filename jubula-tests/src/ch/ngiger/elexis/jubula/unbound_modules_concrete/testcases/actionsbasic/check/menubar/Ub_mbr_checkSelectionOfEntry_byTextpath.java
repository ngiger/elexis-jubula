...
@SrcNode(UUID = "8ab6b083150339b501150364b0070979",
         type = NodeType.TEST_CASE)
public class Ub_mbr_checkSelectionOfEntry_byTextpath {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_mbr_checkSelectionOfEntry_byTextpath.class);
    
    private RuntimeContext rtc;
    
    public Ub_mbr_checkSelectionOfEntry_byTextpath (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
