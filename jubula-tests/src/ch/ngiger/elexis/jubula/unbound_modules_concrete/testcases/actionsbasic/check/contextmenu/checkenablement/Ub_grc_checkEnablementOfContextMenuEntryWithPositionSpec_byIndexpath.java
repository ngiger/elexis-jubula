...
@SrcNode(UUID = "8ab6b0832433fd970124342a158f0024",
         type = NodeType.TEST_CASE)
public class Ub_grc_checkEnablementOfContextMenuEntryWithPositionSpec_byIndexpath {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_grc_checkEnablementOfContextMenuEntryWithPositionSpec_byIndexpath.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_grc;
    
    
    public Ub_grc_checkEnablementOfContextMenuEntryWithPositionSpec_byIndexpath (RuntimeContext _rtc,
