...
@SrcNode(UUID = "8ab6b08316c3bbe20116c3bc6a8a0001",
         type = NodeType.TEST_CASE)
public class Ub_app_externalInputText {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_externalInputText.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_externalInputText (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
