...
@SrcNode(UUID = "8ab6b083150339b501150364afe807ca",
         type = NodeType.TEST_CASE)
public class Ub_app_pressAnyKey_noModifier {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_pressAnyKey_noModifier.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_pressAnyKey_noModifier (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
