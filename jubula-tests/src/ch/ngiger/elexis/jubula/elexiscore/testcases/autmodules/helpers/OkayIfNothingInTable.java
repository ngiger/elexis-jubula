...
import ch.ngiger.elexis.jubula.unbound_modules_concrete.testcases.actionsbasic.select.table.Ub_tbl_selectValueFromRow;
...
import ch.ngiger.elexis.jubula.unbound_modules_concrete.testcases.actionsbasic.check.table.Ub_tbl_checkExistenceOfValueInRow;
...
public class OkayIfNothingInTable {
    ...
    public void execute(
        ...
        //       Used Test Case: 
        //            new ch.ngiger.elexis.jubula.unbound_modules_concrete.testcases.actionsbasic.click.application.Ub_app_clickInActiveWindow(rtc).execute(
        //                1,
        //                1,
        //                50,
        //                "percent",
