...
@SrcNode(UUID = "8ab6b083181d393b01181d8cd405005d",
         type = NodeType.TEST_CASE)
public class Ub_app_externalPressAnyKey {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_externalPressAnyKey.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_externalPressAnyKey (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
