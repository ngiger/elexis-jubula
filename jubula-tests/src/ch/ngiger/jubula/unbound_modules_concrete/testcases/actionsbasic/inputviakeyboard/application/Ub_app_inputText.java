...
@SrcNode(UUID = "8ab6b083150339b501150364afe8079b",
         type = NodeType.TEST_CASE)
public class Ub_app_inputText {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_inputText.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_inputText (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
