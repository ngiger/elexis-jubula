...
@SrcNode(UUID = "8ab6b083150339b501150364afe807a2",
         type = NodeType.TEST_CASE)
public class Ub_app_setToggleKey_CAPSLOCK {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_setToggleKey_CAPSLOCK.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_setToggleKey_CAPSLOCK (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
