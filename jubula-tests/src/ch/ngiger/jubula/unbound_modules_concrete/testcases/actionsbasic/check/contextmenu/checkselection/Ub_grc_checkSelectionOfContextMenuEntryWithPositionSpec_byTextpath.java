...
@SrcNode(UUID = "8ab6b0832433fd97012434448b39006a",
         type = NodeType.TEST_CASE)
public class Ub_grc_checkSelectionOfContextMenuEntryWithPositionSpec_byTextpath {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_grc_checkSelectionOfContextMenuEntryWithPositionSpec_byTextpath.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_grc;
    
    
    public Ub_grc_checkSelectionOfContextMenuEntryWithPositionSpec_byTextpath (RuntimeContext _rtc,
