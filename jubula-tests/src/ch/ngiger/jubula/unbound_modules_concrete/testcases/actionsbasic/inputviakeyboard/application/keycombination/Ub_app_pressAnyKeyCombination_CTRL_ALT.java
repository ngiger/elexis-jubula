...
@SrcNode(UUID = "8ab6b083150339b501150364afe807b9",
         type = NodeType.TEST_CASE)
public class Ub_app_pressAnyKeyCombination_CTRL_ALT {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_app_pressAnyKeyCombination_CTRL_ALT.class);
    
    private RuntimeContext rtc;
    
    public Ub_app_pressAnyKeyCombination_CTRL_ALT (RuntimeContext _rtc
    ) {
        rtc = _rtc;
    }
