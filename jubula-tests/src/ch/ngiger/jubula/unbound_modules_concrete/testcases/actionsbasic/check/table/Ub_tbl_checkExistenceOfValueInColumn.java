...
@SrcNode(UUID = "8ab6b08d294519bd012945ead2dd07aa",
         type = NodeType.TEST_CASE)
public class Ub_tbl_checkExistenceOfValueInColumn {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_tbl_checkExistenceOfValueInColumn.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_tbl;
    
    
    public Ub_tbl_checkExistenceOfValueInColumn (RuntimeContext _rtc,
