...
@SrcNode(UUID = "8ab6b083150339b501150364b007099e",
         type = NodeType.TEST_CASE)
public class Ub_tbc_checkEnablementOfTab_byIndex {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_tbc_checkEnablementOfTab_byIndex.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_tbc;
    
    
    public Ub_tbc_checkEnablementOfTab_byIndex (RuntimeContext _rtc,
