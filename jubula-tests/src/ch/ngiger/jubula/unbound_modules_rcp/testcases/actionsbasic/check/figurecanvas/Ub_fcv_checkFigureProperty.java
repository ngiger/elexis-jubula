...
@SrcNode(UUID = "8ab6b083252ad2ff01252b04760f0001",
         type = NodeType.TEST_CASE)
public class Ub_fcv_checkFigureProperty {

    /** the logger */
    private static Logger log = LoggerFactory.getLogger(Ub_fcv_checkFigureProperty.class);
    
    private RuntimeContext rtc;
    private ComponentIdentifier nn_nn_fcv;
    
    
    public Ub_fcv_checkFigureProperty (RuntimeContext _rtc,
        ...
        aut.execute(
            org.eclipse.jubula.toolkit.gef.GefComponents.createFigureCanvas(nn_nn_fcv)
                .checkFigureProperty(
                    TEXTPATH
                    ,
                    Operator.literalAsEnum(TEXTPATH_OPERATOR)
                    ,
                    PROPERTY_NAME
                    ,
                    PROPERTY_VALUE
