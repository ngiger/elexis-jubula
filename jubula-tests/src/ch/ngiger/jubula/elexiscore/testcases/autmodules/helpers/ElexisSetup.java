...
import ch.ngiger.jubula.elexiscore.testcases.autmodules.helpers.ClickOkayIfMultipleProblems;
import ch.ngiger.jubula.elexiscore.testcases.autmodules.helpers.DefaultSpeicherdauerSetzen;
...
public class ElexisSetup {
    ...
    public void execute(
        ...
        //            new ch.ngiger.jubula.elexiscore.testcases.autmodules.helpers.RestartElexisAndImportArtikelstamm(rtc).execute(
        //                ".*lexis.*"
        //            );
