...
import ch.ngiger.jubula.unbound_modules_swt.testcases.actionsbasic.select.toolbaritem.Ub_tbi_selectMenuEntry_byTextpath;
...
public class Import_Artikelstamm {
    ...
    public void execute(
        ...
        new Ub_tbi_selectMenuEntry_byTextpath(
                rtc,
