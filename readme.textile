...
h3. config variables for the Java main class AUT_run
...
h3. config variables for the rake 
...
h3. Why we do NOT install Jubula in the docker
...
h3. Special considerations for running inside docker
...
h3. Upgrading to a newer version of Jubula
...
*** In the tab "Arguments" set "VM arguments" to @-Dagent_host=wheez@
...
h3. Catch up with previous capabilities
