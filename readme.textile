...
* Use docker 1.9.0 which allows docker build --build-arg=, e.g --build-arg=[ "UID"=`id -u $USER`",  "GID"=`id -g $USER`"], s.a. https://docs.docker.com/engine/reference/builder/ with default values.
